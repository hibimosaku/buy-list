<template>
  <ul class="nav justify-content-center small border" style="margin-bottom:20px">
    <li class="nav-item">
    ...
    <li class="nav-item">
      <router-link to="/buyRequest" class="nav-link"
        >買い物リクエスト</router-link
      >
    </li>
  ...
  <li class="nav-item">
    <a class="nav-link" href="#">品目</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">分類</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">買い物リスト</a>
  </li>
